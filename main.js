...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,yBAAyB;EACzB,uBAAuB;AACzB","sourcesContent":["body {\r\n  background-color: #f0f0f0;\r\n  font-family: sans-serif;\r\n}"],"sourceRoot":""}]);
// Exports
...
function setupUI() {
    ...
    function renderTodos() {
        ...
        const todos = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.getTodosForCurrentProject)();
        ...
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isToday)(due)) {
          dueDisplay = 'Today';
        } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isTomorrow)(due)) {
          dueDisplay = 'Tomorrow';
        } else {
          dueDisplay = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(due, 'dd MMM yyyy'); // e.g., 15 Jul 2025
        }
        ...
        deleteBtn.addEventListener('click', () => {
          (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.deleteTodo)(index);
          renderTodos();
        });
  ...
  addButton.addEventListener('click', () => {
    ...
    const newTodo = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.createTodo)(title, dueDate, priority);
    (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.addTodoToCurrentProject)(newTodo);
  ...
  if (!name || (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.getAllProjects)().includes(name)) return;

  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.createProject)(name);
  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.setCurrentProject)(name);
  renderProjectDropdown();
  renderTodos();
  });
  projectSelect.addEventListener('change', (e) => {
  (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.setCurrentProject)(e.target.value);
  renderTodos();
});
  ...
  const projects = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.getAllProjects)(); // Get an array of all project names
  ...
  projects.forEach((project) => {
    ...
    if (project === (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.getCurrentProject)()) {
...
/* harmony export */   getTodosForCurrentProject: () => (/* binding */ getTodosForCurrentProject),
...
(0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.setupUI)();
